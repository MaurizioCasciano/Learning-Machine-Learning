...
# https://learn.microsoft.com/en-us/training/modules/intro-machine-learning-keras/6-summary
class FashionNeuralNetwork(Model):
    def __init__(self):
        super(FashionNeuralNetwork, self).__init__()
